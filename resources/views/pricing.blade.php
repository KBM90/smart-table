...
<head>
    ...
    <title>Pricing - Smart Table</title>
...
<body class="bg-slate-50 font-sans text-slate-900 antialiased selection:bg-indigo-100 selection:text-indigo-900">
    @php($navLinks = [
    ...
    <div class="relative overflow-x-hidden">
                ...
                <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex h-16 md:h-20 items-center justify-between gap-4">
                        <a href="/" class="flex items-center gap-3 transition hover:opacity-80"
                            ...
                            <span
                                class="flex h-10 w-10 items-center justify-center rounded-2xl bg-indigo-600 text-white shadow-lg shadow-indigo-600/20">
                            ...
                            <div>
                                ...
                                <p class="text-[11px] font-medium uppercase tracking-wider text-slate-500">Service,
                                    simplified</p>
                            </div>
                        </a>
                        ...
                        <button type="button"
                            ...
                            <svg x-show="!mobileOpen" class="h-5 w-5" viewBox="0 0 24 24" fill="none"
        ...
        <main>
                ...
                <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div
                        ...
                        <div
                            ...
                            <div>
                                <div class="flex items-center justify-between">
                                    <h3 id="tier-trial" class="text-lg font-bold leading-8 text-slate-900">7-Day Trial
                                    </h3>
                                </div>
                        ...
                        <div
                            ...
                            <div>
                                <div class="flex items-center justify-between">
                                    <h3 id="tier-monthly" class="text-lg font-bold leading-8 text-slate-900">Monthly
                                    </h3>
                                </div>
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="mt-1.5 text-xs font-semibold text-indigo-400">Save $100 annually
                                    (~$16.60/month)</p>
                                <ul role="list"
            ...
            <section class="py-16 bg-white border-t border-b border-slate-200/50">
                <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="text-center">
                        <h2 class="text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl">Compare Plan Features
                        </h2>
            ...
            <!-- FAQ Section (Fully native CSS/HTML accordion) -->
                ...
                <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="grid gap-12 lg:grid-cols-[0.8fr_1.2fr]">
                        <div>
                            ...
                            <p class="mt-4 text-lg leading-8 text-slate-600">Everything you need to know about our
                                billing and plans.</p>
                        </div>
                        ...
                        <div class="space-y-4">
                            <details
                                ...
                                <summary
                                    ...
                                    <span class="text-base font-bold text-slate-900">How do QR codes work for
                                        tables?</span>
                                    <span
                            ...
                            <details
                                ...
                                <summary
                                    class="flex w-full cursor-pointer items-center justify-between gap-4 text-left focus:outline-none">
                                    <span class="text-base font-bold text-slate-900">Can I add multiple restaurant
                                        locations under one account?</span>
                                    <span
                                        class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-slate-50 text-slate-500 shadow-sm transition duration-300 group-open:rotate-180">
                                        <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2" aria-hidden="true">
                                ...
                                <div class="mt-4 text-sm leading-6 text-slate-600">
                                    Yes. Our Annual plan supports multiple locations. This allows you to manage
                                    different staff lists, separate table configurations, and distinctive menus under a
                            ...
                            <details
                                ...
                                <div class="mt-4 text-sm leading-6 text-slate-600">
                                    ...
                                    prompted to subscribe to either the Monthly or Annual plan inside the Billing
                                    dashboard to resume operation. No credit card is required to sign up for the initial
                                    trial.
                                </div>
                            </details>
                        </div>
            ...
            <section class="py-24 bg-white">
                <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div
                        ...
                        <h2 class="mx-auto max-w-2xl text-3xl font-extrabold tracking-tight sm:text-5xl">Ready to
                            elevate your table service?</h2>
                        <p class="mx-auto mt-6 max-w-xl text-lg leading-8 text-slate-300">Launch Smart Table for your
                            venue today. Setting up takes less than 5 minutes, with no credit card required to start.
                        </p>
