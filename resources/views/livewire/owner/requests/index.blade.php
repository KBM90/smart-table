<div x-data="{
    ...
    <section class="relative overflow-hidden rounded-[2rem] border border-white/80 bg-white/60 p-8 shadow-2xl shadow-indigo-100/50 backdrop-blur-xl">
        ...
        <div class="relative">
            <div class="flex items-center gap-3">
                ...
                <span class="text-xs font-bold uppercase tracking-[0.2em] text-amber-700 bg-amber-50 px-2.5 py-1.5 rounded-xl border border-amber-100 shadow-sm inline-block">
                    Owner Requests
                </span>
            </div>
            ...
            <p class="mt-2 max-w-2xl text-sm leading-relaxed text-slate-600 font-medium">
                Requests update live with Supabase Realtime when configured. Livewire polling is kept as a fallback to ensure you never miss a request.
            </p>
        </div>
    </section>
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-20 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="mt-1 text-xs text-slate-400 max-w-xs leading-relaxed">You're all caught up! New requests will appear here instantly.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
